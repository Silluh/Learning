...
/**
 * The Class WindowsUIComponent.
 *
 * @author Daniel Žažo
 * @date 30. 3. 2015
 */
public class WindowsUIComponent extends AbstractOperatingSystemUI {

	/** The dimension of main window. */
	private final Dimension	dimensionOfMainWindow			= new Dimension(800, 800);

	/** The dimension area log panel. */
	private final Dimension	dimensionAreaLogPanel			= new Dimension(720, 430);

	/** The dimension of button switch layout. */
	private final Dimension	dimensionOfButtonSwitchLayout	= new Dimension(130, 60);

	/** The dimension of result panel. */
	private final Dimension	dimensionOfResultPanel			= new Dimension(725, 440);

	/** The dimension of open graph in new window. */
	private final Dimension	dimensionOfOpenGraphInNewWindow	= new Dimension(300, 50);

	/** The dimension of panel mouse modes. */
	private final Dimension	dimensionOfPanelMouseModes		= new Dimension(130, 60);
	...
	public Dimension getDimensionButtonSwitchLayout() {
		return dimensionOfButtonSwitchLayout;
	}
